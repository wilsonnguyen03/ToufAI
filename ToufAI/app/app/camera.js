...
import { View, StyleSheet, TouchableOpacity, Alert, NativeModules, NativeEventEmitter, findNodeHandle } from 'react-native';
...
export default function CustomCamera() {
  ...
  useEffect(() => {
    ...
    eventListener.current = cameraEventEmitter.addListener('onCameraResult', (event) => {
      ...
      if (event.status === 'success' && event.uri) {
        // On success, navigate to the preview screen with the photo's URI
        router.push({
          pathname: '/previewphoto',
